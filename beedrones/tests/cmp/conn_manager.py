...
from beedrones.cmp.conn_manager import CmpApiConnectionManager
...
class CmpApiConnectionManagerTestCase(BeedronesTestCase):
    ...
    def setUpClass(cls):
        ...
        token = 'token1'
        key = 'LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUlJQklqQU5CZ2txaGtpRzl3MEJBUUVGQUFPQ0FROEFNSUlCQ2dLQ0FRRUFzK01ZUl' \
        ...
        cls.client = CmpApiConnectionManager(endpoint, token, key=key, timeout=5.0)
