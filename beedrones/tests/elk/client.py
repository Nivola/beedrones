...
class ElkClientTestCase(BeedronesTestCase):
    ...
    def test_space_add(self):
        ...
        #res = self.client.space.add(space_id, 'nome_prova', 'desc prova')
        space_id = res['id']
    ...
    def test_role_add(self):
        ...
        #res = self.client.role.add(role_name, 'nome_prova', 'desc prova')
        #role_name = res['id']
    ...
    def test_role_mapping_add(self):
        ...
        #res = self.client_elastic.role_mapping.add(role_mapping_name, role_name)
    ...
    def test_user_add(self):
        ...
        #res = self.client_elastic.user.add(user_name, password, role)
