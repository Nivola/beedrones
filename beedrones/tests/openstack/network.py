...
class OpenstackNetworkTestCase(OpenstackClientTestCase):
    ...
    def test_create_network(self):
        ...
        res = self.client.network.create(name, project, physical_network, shared, qos_policy_id, external, segments,
    ...
    def test_create_subnet(self):
        ...
        res = self.client.network.subnet.create(name, network_id, project, gateway_ip, cidr, allocation_pools,
    ...
    def test_update_subnet(self):
        ...
        res = self.client.network.subnet.update(subnet_id, name, network_id, tenant_id, gateway_ip, cidr,
                                                allocation_pools, enable_dhcp, host_routes, dns_nameservers)
        self.logger.debug(self.pp.pformat(res))
    ...
    def test_create_port(self):
        ...
        res = self.client.network.port.create(name, network_id, fixed_ips, host_id, profile, vnic_type, device_owner,
    ...
    def test_update_port(self):
        ...
        res = self.client.network.port.update(port_id, name, network_id, fixed_ips, host_id,
                                              profile, vnic_type, device_owner,
                                              device_id, security_groups, port_security_enabled)
        self.logger.debug(self.pp.pformat(res))
    ...
    #     res = self.client.network.floatingip.create_floating_ip(network_id, project, port_id)
    #     self.logger.debug(self.pp.pformat(res))
    #
    # def test_floating_ip_update(self):
    #     floatingip_id = '3f069a11-26bb-4e09-b929-1d6eaadc64bf'
    #     network_id = None
    #     tenant_id = None
    #     port_id = None
    #     res = self.client.network.floatingip.update_floating_ip(floatingip_id, network_id, tenant_id, port_id)
    #     self.logger.debug(self.pp.pformat(res))
    #
    # def test_floating_ip_remove(self):
    #     floatingip_id = '3f069a11-26bb-4e09-b929-1d6eaadc64bf'
    #     res = self.client.network.floatingip.delete_floating_ip(floatingip_id)
    #     self.logger.debug(self.pp.pformat(res))
    ...
    def test_security_group_rule_create(self):
        ...
        direction = 'ingress'
        res = self.client.network.security_group.create_rule(sg_id,
                                                             direction,
                                                             ethertype='IPv4',
                                                             port_range_min=1000,
                                                             port_range_max=1010,
