...
class OpenstackClientTestCase(BeedronesTestCase):
    ...
    def test_identity_role_assignments(self):
        ...
        project = res["id"]
        res = self.client.identity.role.assignments(role=role_id, group=None, user=None, project=project, domain=None)
        self.logger.debug(self.pp.pformat(res))
    ...
    def test_volume_create(self):
        ...
        res = self.client.volume_v3.create(
            size=20,
            availability_zone=None,
            source_volid=None,
            description="",
