...
class AwxClientTestCase(BeedronesTestCase):
    ...
    def test_project_add(self):
        ...
        try:
            ...
            credential = res[0]['id']
        res = self.client.project.add('prova_prj',
                                      scm_type='git',
    ...
    def test_credential_add_ssh2(self):
        ...
        priv_key = '-----BEGIN RSA PRIVATE KEY-----\n' \
                   ...
                   '-----END RSA PRIVATE KEY-----'
        pass_phrase = 'prova'
        res = self.client.credential.add_ssh('prova_cred2', 1, 'prova', ssh_key_data=priv_key,
                                             ssh_key_unlock=pass_phrase)
        credential = res['id']
    ...
    def test_job_template_add(self):
        ...
        # create template
        res = self.client.job_template.add('prova_template', 'run', inventory, project, playbook,
                                           ask_credential_on_launch=True,
                                           ask_variables_on_launch=True, ask_limit_on_launch=True)
        job_template = res['id']
