...
class VeeamUtilTestCase(BeedronesTestCase):
    ...
    def setUp(self):
        ...
        # print (str(params))
        veeamTest = {
            "uri": "http://tst-veeamsrv.tstsddc.csi.it:9399",
            "user": "Administrator",
            "pwd": "",
            "verified": False,
        }
    ...
    def test_edit_job(self):
        ...
        self.assertTrue(
            res[
                "http://tst-veeamsrv.tstsddc.csi.it:9399/api/jobs/801ab7dd-de71-4cce-89af-467de5e48312?action=editstatus"
            ]
            == "OK"
        )
    ...
    def test_old_create_job(self):
        ...
        res = self.util.jobs.old_create_job(
            template2Copy,
            "Crea_backup_from_api",
            "urn:veeam:Repository:b03eb865-79eb-4450-bc52-48a7472314ca",
            "urn:VMware:Vm:7f6b6270-1f3b-4dc6-872f-2d1dfc519c00.vm-3154",
            "boraso2",
        )
        """
        self.logger.debug("TaskId %s , State %s, Operation %s" % (res['data']['Task']['TaskId'],res['data']['Task']['State'],res['data']['Task']['Operation']))
    ...
    def test_create_job(self):
        ...
        res = self.util.jobs.create_job(
            template2Copy,
            "Crea_backup_from_api_Last",
            "urn:veeam:Repository:b03eb865-79eb-4450-bc52-48a7472314ca",
            "urn:VMware:Vm:7f6b6270-1f3b-4dc6-872f-2d1dfc519c00.vm-3154",
            "boraso2",
        )
    ...
    def test_create_replica_job(self):
        ...
        res = self.util.replica.create_replica_job(
            dest_esxiname,
            dest_datastore,
            dest_folder,
    ...
    def test_create_replica_mapping(self):
        ...
        res = self.util.replica.create_replica_mapping(
            job_replica_name, job_replica_description, original_vm, replica_vm
        )
        self.assertTrue(res)
        self.logger.info(res)
    ...
    def test_add_replica_reiprule(self):
        ...
        return self.util.replica.add_replica_reiprule(
            replica_job_name,
            "10.102.184.*",
            "192.168.214.*",
            "192.168.214.1",
            dns="10.101.0.10,10.101.0.105",
        )
    ...
    def test_add_replica_network_mapping(self):
        ...
        return self.util.replica.add_replica_network_mapping(
            replica_job_name, source_esxi, source_net, target_esxi, target_net
        )
    ...
    def test_giro_replica_completo(self):
        ...
        res = self.util.replica.add_replica_network_mapping(
            replica_job_name, source_esxi, source_net, target_esxi, target_net
        )

        # ReIP
        res = self.util.replica.add_replica_reiprule(
            replica_job_name,
            "192.168.216.*",
            "192.168.214.*",
            "192.168.214.1",
    ...
    def test_giro_replica_mapping_completo(self):
        ...
        res = self.util.replica.add_replica_network_mapping(
            job_replica_name, source_esxi, source_net, target_esxi, target_net
        )
