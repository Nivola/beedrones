...
conn = {"host": "10.102.184.67", "port": 8080, "path": "/engine-rest", "proto": "http"}
...
class WorkFlowEngineTestCase(BeehiveTestCase):
    ...
    def test_wf_startproc(self):
        ...
        res = WFTEST.process_instance_start_processDefinitionId(
            "Checkmail_simple", businessKey="", variables=parameters
        )
        self.logger.info(self.pp.pformat(res))
    ...
    def test_wf_process_instances_delete(self):
        ...
        self.intialize()
        listProc = [
            "c24626fa-1525-11e7-a173-061b3800031f",
            "8426fbf4-1525-11e7-a173-061b3800031f",
        ]
    ...
    def test_wf_process_instance_get_single_variable(self):
        global WFTEST
        self.intialize()
        res = WFTEST.process_instance_variable_get(
            processInstanceId="938f021d-259f-11e7-b663-061b3800031f",
    ...
    def test_wf_process_instance_upload_variable(self):
        global WFTEST
        self.intialize()
        res = WFTEST.process_instance_variable_file_upload(
            processInstanceId="938f021d-259f-11e7-b663-061b3800031f",
            varName="Variable_2",
            varContent="POEPROEPROEPROEP",
        )
        self.logger.info(self.pp.pformat(res))
    ...
    def test_wf_process_instance_update_variables(self):
        ...
        res = WFTEST.process_instance_variables_update(
            processInstanceId="938f021d-259f-11e7-b663-061b3800031f",
    ...
    def test_wf_process_instance_set_variable(self):
        global WFTEST
        self.intialize()
        res = WFTEST.process_instance_variable_set(
            processInstanceId="938f021d-259f-11e7-b663-061b3800031f",
    ...
    def test_wf_process_instance_delete_variable(self):
        global WFTEST
        self.intialize()
        res = WFTEST.process_instance_varariable_delete(
            processInstanceId="938f021d-259f-11e7-b663-061b3800031f",
            varName="VariableString_2",
        )
        self.logger.info(self.pp.pformat(res))
    ...
    def test_wf_tasks_using_process_name(self):
        ...
        self.intialize()
            ...
            "processInstanceId": "9f69862a-259f-11e7-b663-061b3800031f",
            "name": "verify",
        }
