...
class GrafanaClientTestCase(BeedronesTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.client_grafana = GrafanaManager(host=grafana_host, port=grafana_port, protocol=grafana_protocol, username=grafana_user, pwd=grafana_pwd)
    ...
    def test_dashboard_copy(self):
        ...
        division = 'div01'
        account = 'acc01'
        res = self.client_grafana.dashboard.add_dashboard(dashboard_to_search, folder_id_to, organization, division, account)
