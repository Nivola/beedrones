...
class ElasticManager(object):
    def __init__(self, es: Elasticsearch = None, host=None, hosts=None, user=None, pwd=None, proxy=None, timeout=60.0):
        self.logger = getLogger(self.__class__.__module__ + '.' + self.__class__.__name__)
        ...
        if es is not None:
            ...
            if host is not None:
                ...
                for host_item in hosts:
                    ...
                    elk_hosts.append(str(host_item))
