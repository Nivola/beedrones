...
class VsphereSystem(VsphereObject):
    ...
    def version(self):
        ...
        if self.has_nsx():
            ...
            version['nsx'] = '%s.%s.%s.%s' % (nsx_info['majorVersion'], nsx_info['minorVersion'],
                                              nsx_info['patchVersion'], nsx_info['buildNumber'])
...
class VsphereSystemNsx(VsphereSystem):
    ...
    def configure_appliance_time_settings(self, ntp_server='', datetime='', timezone=''):
        ...
        res = self.call('/api/1.0/appliance-management/system/timesettings', 'PUT', data,
    ...
    def configure_appliance_syslog(self, hosname, port, protocol):
        ...
        res = self.call('/api/1.0/appliance-management/system/syslogserver', 'PUT', data,
                        headers={'Content-Type': 'text/xml'}, timeout=60)
        return res
    ...
    def query_appliance_component(self, component):
        ...
        """
        res = self.call('/api/1.0/appliance-management/components/component/%s' % component, 'GET', '')
        return res
    ...
    def query_appliance_component_dependency(self, component):
        ...
        :param component: component id
        """
        res = self.call('/api/1.0/appliance-management/components/component/%s/dependencies' % component, 'GET', '')
        return res
    ...
    def query_appliance_component_status(self, component):
        ...
        :param component: component id
        """
        res = self.call('/api/1.0/appliance-management/components/component/%s/status' % component, 'GET', '')
        return res
    ...
    def restart_appliance_webapp(self):
        ...
        res = self.call('/api/1.0/appliance-management/components/component/APPMGMT/restart', 'POST', '')
        return res
